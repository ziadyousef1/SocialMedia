...
{
    public class UpdatePostCommandHandler : IRequestHandler<UpdatePostCommand, OperationResult<PostEntity>>
    {
        ...
        public async Task<OperationResult<PostEntity>> Handle(UpdatePostCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    post.UpdatePhoto(request.PhotoUrl, request.PhotoFileName);
                }
